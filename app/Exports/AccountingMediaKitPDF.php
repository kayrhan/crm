...
class AccountingMediaKitPDF extends tFPDF {
    public $pageH = 297;
    public $pageW = 210;
    public $headerH = 50;
    public $footerH = 36;
    ...
    function Footer()
    {
        ...
        $rowW = [70,50,60];
        $matrix = [
            ["MediaKit Produksiyon","Film Pazarlama ve Ticaret A.S.","TAX Office: Turkiye İzmir Bornova V.D.","TAX Number: 6141312199","Mansuroğlu Mah., 1593/1 Sk.,","No: 10/58 İzmir/Turkiye"],
            ["Contact",$this->info_mail,"www.mediakitproduction.com","Tel.: +90 232 935 11 05"],
            ["Bank Details","T.C. İs Bankasi","IBAN EURO: TR70 0006 4000 0023 3870 1012 51","IBAN USD:   TR98 0006 4000 0023 3870 0712 59","IBAN TL:      TR26 0006 4000 0013 3870 1599 57" ,"SWIFT/BIC:  ISBKTRIS","Barbaros mahallesi, Sebboy sokak","No: 4/1 34746 Atasehir / Istanbul"],
        ];
    ...
    public function getCustomerAddress(){
        ...
        $cell_width = 90;
        $tmp_Y= $this->GetY();
        $this->MultiCell($this->GetStringWidth("MediaKit Production A.S. Mansuroglu Mh. 1593/1 Sk. No: 10/58 Izmir/Turkiye") + 10,$line_height,"MediaKit Production A.S. Mansuroglu Mh. 1593/1 Sk. No: 10/58 Izmir/Turkiye",0,1);
        $this->Line($this->page_indent+1,$tmp_Y+$line_height,$this->GetStringWidth("MediaKit Production A.S. Mansuroglu Mh. 1593/1 Sk. No: 10/58 Izmir/Turkiye")+$this->page_indent+1,$tmp_Y+$line_height);
