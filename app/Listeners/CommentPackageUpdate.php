    ...
    public function handle(PackageUpdated $event): void {
        try {
            ...
            if($ticket) {
                ...
                $comment->message = "A package of this ticket has just updated. You can check it via: " .  route("package-tracking.update", [$event->package->id]);
            ...
            Helper::create_debug_log(
                __CLASS__,
                __FUNCTION__,
                "Something went wrong while trying to comment a package's creation!",
                9,
