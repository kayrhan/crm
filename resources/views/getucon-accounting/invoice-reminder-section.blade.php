<div class="row w-100 m-0 pl-1 py-1">
    <div class="col-md-12 col-lg-12">
        ...
        <div class="row" id="reminder-section" @if(!$current_reminder) style="display:none;" @endif>
            <div class="card-body">
                <form action="{{ url('/getucon/accounting/set-reminder') }}" method="POST" id="set_reminder_form">
                    @csrf
                        ...
                        <div class="col-md-6">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group row border-bottom">
                                        ...
                                        <div class="col-md-3 p-0">
                                            <select class="form-control standard-form-input" name="payment_method" id="payment_method">
                                                ...
                                                <tbody>
                                                    @foreach($payment_logs as $log)
                                                        @php
                                                            ...
                                                            $bank = App\InvoiceReminderBanks::query()->find($log->bank_id);
                                                        @endphp
                                                            <tr>
                            ...
                            @if(count($deadline_logs) > 0)
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12">
                                                <div class="form-group row border-bottom" style="border: 1px solid #ebecf1 !important; padding-top: 12px;">
                                                    <label class="col-md-3 form-label form-label my-auto current-reminder">
                                                        Deadline Logs
                    ...
                    <input type="hidden" id="invoice-number" name="invoice_number">
