...
@section('content')
    ...
    <div class="row" style="margin-top: 20px;">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="formSection" action="{{ route('stocks.update') }}" method="POST">
                        @csrf
                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <select name="office" id="office" class="form-control">
                                                    ...
                                                    @foreach ($offices as $office)
                                                        <option @if ($stock->office_id == $office->id) selected @endif value="{{ $office->id }}">
                                                            {{ $office->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group row border-bottom">
                                            ...
                                            <div class="col-md-9">
                                                <input value="{{ $stock->brand }}" type="text" name="brand" id="brand"
                                                    class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group row border-bottom">
                                            ...
                                            <div class="col-md-9">
                                                <input value="{{ $stock->model }}" type="text" name="model" id="model"
                                                    class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group row border-bottom">
                                            ...
                                            <div class="col-md-9">
                                                <textarea id="desc_offer" name="desc_offer" class="form-control"
                                                    rows="3">{{ $stock->desc_offer }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group row border-bottom">
                                            ...
                                            <div class="col-md-9">
                                                <textarea id="desc_original" name="desc_original" class="form-control"
                                                    rows="3">{{ $stock->desc_original }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group row border-bottom">
                                            ...
                                            <div class="col-md-9">
                                                <input value="{{ $stock->stock }}" type="number" name="stock" id="stock"
                                                    class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group row border-bottom">
                                            ...
                                            <div class="col-md-9">
                                                <div id="link-container"
                                                    ...
                                                    <a class="text-primary" href="{{ $stock->link }}"
                                                        target="_blank">{{ $stock->link }}</a>
                                                    <input value="{{ $stock->link }}" type="text" name="stock_link"
                                                        id="stock_link" class="d-none form-control" d-none>
                                        ...
                                        <div class="form-group row border-bottom">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <x-attachment type="Stock_Brochure" buttonclass="submitButton"
                                                    formid="formSection" maxsize="15" maxfiles="3" header="" acceptedTypes=".pdf" />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group row border-bottom">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <x-attachment type="Stock_Picture" buttonclass="submitButton"
                                                    formid="formSection" maxsize="15" maxfiles="5" header="" acceptedTypes="image/jpeg,image/png,image/jpg" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 col-lg-6 col-12">
                                <x-attachment-list type="Stock_Brochure" ownerid="{{ $stock->id }}"
                                    header="Product Brochures" />

                                <x-attachment-list type="Stock_Picture" ownerid="{{ $stock->id }}"
    ...
    <script>
        function toggleLink() {
            let linkCont = $("#link-container");
            let linkButton = linkCont.find("button");

            let link = linkCont.find("a");
            let linkInput = linkCont.find("input")
            let buttonIcon = linkButton.find("i");

            link.html(linkInput.val());
            link.toggleClass("d-none");
            linkInput.toggleClass("d-none");
            buttonIcon.toggleClass("fa-pencil-square-o")
            buttonIcon.toggleClass("fa-check")
            linkButton.toggleClass("text-info")
            linkButton.toggleClass("text-success")
        }
    </script>
    ...
    <script>
        ...
        validate(["office", "brand", "model", "stock"], oneTime);;
