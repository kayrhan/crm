...
<div class="page-header">
	<div class="page-leftheader">
		<h4 class="page-title mb-0">{{ucfirst(trans('words.update_role'))}}</h4>
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="#"><i class="fe fe-file-text mr-2 fs-14"></i>{{ucfirst(trans('words.roles'))}}</a></li>
			<li class="breadcrumb-item active" aria-current="page"><a href="#">{{ucfirst(trans('words.update_role'))}}</a></li>
		</ol>
	</div>
</div>
<!--End Page header-->
					...
					<div class="row">
						<div class="col-lg-6 col-md-6">
							<div class="form-group">
								<label class="form-label">{{ucfirst(trans('words.role_name'))}}</label>
