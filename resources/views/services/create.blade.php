    ...
    <div class="row mt-3">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="formSection" method="POST" action="{{ url("/services") }}">
                        @csrf
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group row border-bottom">
                                            ...
                                            <div class="col-md-10">
                                                <input id="title" type="text" name="title" class="form-control privateValidate" placeholder="Title">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group row border-bottom">
                                            ...
                                            <div class="col-md-10">
                                                <input id="access-link" type="url" name="access-link" class="form-control privateValidate" placeholder="Provider">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group row border-bottom">
                                            ...
                                            <div class="col-md-10">
                                                <textarea id="description" name="description" class="form-control privateValidate"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group row border-bottom">
                                            ...
                                            <div class="col-md-10">
                                                <input id="provider" type="text" name="provider" class="form-control privateValidate" placeholder="Provider">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group row border-bottom">
                                            ...
                                            <div class="col-md-8">
                                                <input id="service-amount" name="service-amount" class="form-control privateValidate" data-type="currency" placeholder="Service Amount">
                                            </div>
                                            <div class="col-md-2">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group row border-bottom">
                                            ...
                                            <div class="col-md-10">
                                                <input id="beginning-date" name="beginning-date" type="date" class="form-control privateValidate">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group row border-bottom">
                                            ...
                                            <div class="col-md-10">
                                                <input id="expiring-date" name="expiring-date" type="date" class="form-control privateValidate">
                                            </div>
                                        </div>
                                    </div>
                                </div>
