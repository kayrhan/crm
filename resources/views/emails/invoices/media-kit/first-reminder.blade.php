                            ...
                            <td style="width:210.0pt; padding:26.25pt 0 22.5pt 0">
                                <p class="MsoNormal">
                                    <span style="font-size:10.0pt; font-family:'Tahoma', sans-serif">
                                        <a href="https://www.mediakitproduction.com" target="_blank"><img width="300" src="{{ asset("/images/logos/MediaKit-light.png") }}" style="width:3.125in" alt="MediaKit Production"></a>
                                    </span>
                                </p>
                            </td>
                    ...
                    <table class="MsoNormalTable" style="width:450.0pt; border:none; border-collapse:collapse; mso-yfti-tbllook:1184; mso-padding-alt:0">
                        <tr style="mso-yfti-irow:0; mso-yfti-firstrow:yes; mso-yfti-lastrow:yes">
                            ...
                            <td style="width:210.0pt; padding:0"><br>
                                <div style="font-size:10.0pt;font-family: Tahoma, Verdana, Segoe, sans-serif;">
                                    Dear Customer,<br><br>
                                    We are sorry to inform you that you still have an outstanding payment to date.<br><br>
                                    ...
                                    <table class="othertable" style="width: 100%">
                                        <tbody>
                                            <tr>
                                    ...
                                    <strong>Delay with payment since: {{ count(\Carbon\CarbonPeriod::create(\Carbon\Carbon::parse($invoice->deadline)->format("d.m.Y"), \Carbon\Carbon::now())) - 1}} days.</strong><br><br><br>
                                    @if($invoice->mail_text_1)
                                    <strong>Additional Information:</strong><br>
                                    {!! $invoice->mail_text_1 !!}<br><br>
                                    @endif
                                    ...
                                    <div><br>
                                        <div align="center">
                                            <table class="MsoNormalTable" style="width:100.0%; background: white; border-collapse:collapse; mso-yfti-tbllook:1184; mso-padding-alt:0">
                                                <tr style="mso-yfti-irow:0; mso-yfti-firstrow:yes; mso-yfti-lastrow:yes">
                                                    <td style="width:100.0%; padding:0">
                                                        <table class="MsoNormalTable" style="width:450.0pt; border:none; border-collapse:collapse; mso-yfti-tbllook:1184; mso-padding-alt:0">
                                                            <tr style="mso-yfti-irow:0; mso-yfti-firstrow:yes; mso-yfti-lastrow:yes">
                                                                <td style="width:100.0%; padding:0">
                                                                    <p class="MsoNormal"><strong><span style="font-size:7.0pt; font-family:'Tahoma', sans-serif; color:#0D385C">MediaKit Production</span></strong></p>
                                                                </td>
                                                            <tr>
                                                                <td>&nbsp;</td>
                                                            </tr>
                                                            <tr style="mso-yfti-irow:0; mso-yfti-firstrow:yes; mso-yfti-lastrow:yes">
                                                                <td style="width:100.0%; padding:0">
                                                                    <table style="font-size:8.5pt; font-family:'Tahoma',sans-serif; color:#0D385C">
                                                                        ...
                                                                        <tr><td>[Web]</td><td>&nbsp;</td><td>&nbsp;</td><td><a style="color:#000 !important;text-decoration:none" href="https://www.mediakitproduction.com" target="_blank" title="MediaKit Production"><span style="color:#0D385C">www.mediakitproduction.com</span></a></td></tr>
                                                                    </table>
                                                                </td>
                                                            </tr>
                                                        </table>
