                        ...
                        <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
                            ...
                            <td width=280 style='width:210.0pt;padding:0cm 0cm 0cm 0cm'><br>
                                <div style='font-size:10.0pt;font-family:"Tahoma",sans-serif'>
                                    ...
                                    Sehr geehrte Geschäftsleitung,<br><br>

                                    zum Kunden <strong>{{$customer->org_name}}</strong> haben wir ein Blacklisting.<br><br>

                                        Bitte zur Kenntnis nehmen und Weiteres veranlassen.<br><br>
                                    ...
                                    <table  width="100%" class="othertable">
                                        ...
                                        <tr>
                                            <td width="50%" style="padding:2px 5px;">Bisher geleistete Zahlungen:</td>
