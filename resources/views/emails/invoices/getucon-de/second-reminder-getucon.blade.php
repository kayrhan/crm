                        ...
                        <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
                            ...
                            <td width=280 style='width:210.0pt;padding:0cm 0cm 0cm 0cm'><br>
                                <div style='font-size:10.0pt;font-family:"Tahoma",sans-serif'>
                                    ...
                                    nach unserer Zahlungserinnerung vom <strong>{{\Carbon\Carbon::parse($invoice->post_mail_1)->format('d.m.Y')}}</strong> konnten wir bis dato keinen Zahlungseingang unserer offenen Forderung feststellen.<br><br>
                                    Wir bitten Sie hierzu um Prüfung und Ausgleich.<br><br>
                                    Im Anhang finden Sie nochmals unsere <strong>Rechnung {{$invoice->invoice_no}}.</strong><br><br>

                                    Wir bitte Sie die offene Forderung in Höhe von <strong>{{number_format($invoice_amount - $total_payments, 2, ',', '.')}} EUR</strong> innerhalb von <strong>7 Tagen</strong> auf unser Geschäftskonto zu überweisen.<br><br>
