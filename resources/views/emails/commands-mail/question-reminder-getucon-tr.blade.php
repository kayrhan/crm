                        ...
                        <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
                            ...
                            <td width=280 style='width:210.0pt;padding:0cm 0cm 0cm 0cm'><br>
                                <div style='font-size:10.0pt;font-family:"Tahoma",sans-serif'>
                                    ...
                                    <p>To go on with this ticket, we need feedback from your site.<br>
                                        Can you give a comment please? <br><br>
                                        You can answer to this mail directly. <br><br>
                                        Thank you very much.
                                    </p>
                                    ...
                                    <table class="ticket_table" cellspacing="0" cellpadding="0" width="100%"
                                        ...
                                        <tr style="border: 1px solid black;">
                                            <td colspan="4" style="border: 1px solid black;padding: 5px; "><strong>Ticket
                                                    ID:</strong></td>
                                            <td style="border: 1px solid black;padding: 5px;">
                                                <strong><a href="{{ url('/update-ticket/' . $ticket->id) }}" target="_blank">#{{$ticket->id}}</a></strong></td>
                                            <td colspan="1" style="border: 1px solid black;padding: 5px;"><strong>Status:</strong></td>
                                            <td colspan="4" style="border: 1px solid black;padding: 5px;">Question</td>

                                        </tr>
                                        <tr style="border: 1px solid black;">
                                            <td colspan="2" style="border: 1px solid black;padding: 5px;"><strong>Subject:</strong>
                                            </td>
                                            <td colspan="8" style="border: 1px solid black;padding: 5px;"><p>{{$ticket->name}}</p>
                                            </td>

                                        </tr>

                                        <tr style="border: 1px solid black;">
                                            <td colspan="10" style="border: 1px solid black;padding: 5px;  text-align: center;">
                                            ...
                                            <tr style="border: 1px solid black;">
                                                <td colspan="10" style="padding: 5px;"  >
                                                    <div style="text-align: right">
                                                        {{$commant["name"]}} ({{$commant["date"]}})
                                                    </div>
                                                    <div>{!! $commant["message"]!!}</div>
                                                </td>
                                            </tr>
                                        @endforeach
                                        @if($comment_more_than_three)
                                            <tr style="border: 1px solid black;">
                                                <td colspan="10" style="border: 1px solid black;padding: 5px; text-align: center ">
                                                    <strong><a href="{{ url('/update-ticket/' . $ticket->id) }}" target="_blank">Continue reading...</a></strong></td>
                                            </tr>
                                        @else
                                            <tr style="border: 1px solid black;">
                                                <td colspan="10" style="border: 1px solid black;padding: 5px; text-align: center ">
                                                    <strong>No further comments</strong></td>
                                            </tr>
                                        @endif
                                    </table>
                                    <br>
