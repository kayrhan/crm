   ...
   mso-padding-alt:0cm 0cm 0cm 0cm'>
                        <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
                            <td width=280 style='width:210.0pt;padding:26.25pt 0cm 22.5pt 0cm'>
                                <p class=MsoNormal><span style='font-size:10.0pt;font-family:"Tahoma",sans-serif'><a href="https://{{$website}}" target="_blank"><img border=0 width=300
   ...
   mso-padding-alt:0cm 0cm 0cm 0cm'>
                        <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
                            ...
                            <td width=280 style='width:210.0pt;padding:0cm 0cm 0cm 0cm'><br>
                                <div style='font-size:10.0pt;font-family:"Tahoma",sans-serif'>
                                    ...
                                    vielen Dank für Ihre Angebotsanfrage.<br><br>
                                    Im Anhang finden Sie unser Angebot und ggf. weitere Dokumente.<br><br>
                                    @if($additional_text)
                                        <strong>Sonstige Anmerkung:</strong><br>
                                        <div id="p-tag" style='font-size:10.0pt;font-family:"Tahoma",sans-serif'>{!! $additional_text !!}</div>
                                    @endif
     ...
     mso-yfti-tbllook:1184;mso-padding-alt:0cm 0cm 0cm 0cm'>
       ...
       1184;mso-padding-alt:0cm 0cm 0cm 0cm'>
        ...
        [T] 069-34866710<br>
        [E] <a style="color:#000 !important;text-decoration:none" href="mailto:vertrieb@getucon.de" target="_blank"
               title="Email"><span style='color:#0D385C'>vertrieb@getucon.de</span></a><br>
