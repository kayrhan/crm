    ...
    <table class="MsoNormalTable" style="width:100.0%; background:white; border: none; border-collapse:collapse; mso-yfti-tbllook:1184; mso-padding-alt:0">
        ...
        <tr style="mso-yfti-irow:1">
            <td style="width:100.0%; padding:0">
                <div align="center">
                    <table class="MsoNormalTable" style="width:450.0pt; border-collapse:collapse; mso-yfti-tbllook:1184; mso-padding-alt:0">
                        <tr style="mso-yfti-irow:0; mso-yfti-firstrow:yes; mso-yfti-lastrow:yes">
                            <td style="width:210.0pt; padding:26.25pt 0 22.5pt 0">
                                <p class="MsoNormal"><span style="font-size:10.0pt; font-family:'Tahoma', sans-serif"><a href="https://www.mediakitproduction.com" target="_blank"><img width="300" src="{{ asset("/images/logos/MediaKit-light.png") }}" style="width:3.125in" alt="MediaKit"></a></span></p>
                            </td>
        ...
        <tr style="mso-yfti-irow:3">
            <td style="width:100.0%; background: white; padding:0">
                <div align="center">
                    <table class="MsoNormalTable" style="border: none; width:450.0pt; border-collapse:collapse; mso-yfti-tbllook:1184; mso-padding-alt:0">
                        <tr style="mso-yfti-irow:0; mso-yfti-firstrow:yes; mso-yfti-lastrow:yes">
                            ...
                            <td style="width:210.0pt; padding:0"><br>
                                <div style="font-size:10.0pt; font-family:'Tahoma', sans-serif">
                                    Dear Customer,<br><br>
                                    Thank you for your request for a quote.<br><br>
                                    Attached you will find our offer and any other documents.<br><br>
                                                ...
                                                <tr style="mso-yfti-irow:0; mso-yfti-firstrow:yes; mso-yfti-lastrow:yes">
                                                    <td style="width:100.0%; padding:0">
                                                        <table class="MsoNormalTable" style="width:450.0pt; border-collapse:collapse; mso-yfti-tbllook:1184; mso-padding-alt:0; border: none">
                                                            ...
                                                            <tr style="mso-yfti-irow:0; mso-yfti-firstrow:yes; mso-yfti-lastrow:yes">
                                                                <td style="width:100.0%; padding:0">
                                                                    <table style="font-size:8.5pt; font-family:'Tahoma', sans-serif; border: none; border-collapse: collapse; color:#0D385C">
