                        ...
                        <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
                            ...
                            <td width=280 style='width:210.0pt;padding:0cm 0cm 0cm 0cm'><br>
                                <div style='font-size:10.0pt;font-family:"Tahoma",sans-serif'>
                                    ...
                                    <p>Hello,</p>
                                    <p>You have an update. Please Check.</p>
                                    ...
                                    <table class="ticket_table" cellspacing="0" cellpadding="0" width="100%"
                                        ...
                                        <tr style="border: 1px solid black;">
                                            ...
                                            <td style="border: 1px solid black;padding: 5px;">
                                               <a href="{{ url('/update-ticket/' . $ticket->id) }}" target="_blank"> <strong> #{{$ticket->id}}</strong></a></td>
                                        </tr>
                                        <tr style="border: 1px solid black;">
                                        ...
                                        @endif
                                        <tr style="border: 1px solid black;">
                                            <td style="border: 1px solid black;padding: 5px;"><strong>From:</strong>
                                            </td>
                                            <td style="border: 1px solid black;padding: 5px;">
                                                <p>{{$user_discussion->first_name}} {{$user_discussion->surname}}</p>
                                            </td>
                                        </tr>
                                        <tr style="border: 1px solid black;">
                                            <td style="border: 1px solid black;padding: 5px;"><strong>Created:</strong></td>
                                            <td style="border: 1px solid black;padding: 5px;"><p>{{$ticket_time}}</p>
                                            </td>
                                        </tr>
                                        <tr style="border: 1px solid black;">
                                            <td style="border: 1px solid black;padding: 5px;" valign="top"><strong>Comment:</strong><br>
                                                {{\Carbon\Carbon::parse($discussion_date)->format("d.m.Y [H:i:s]")}}
                                            </td>
                                            <td style="border: 1px solid black;padding: 5px;">
                                                <p>{!!  $discussion_message!!}</p></td>
                                        </tr>
                                    </table>
                                    <br>
