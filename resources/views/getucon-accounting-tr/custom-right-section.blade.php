<div class="col-lg-8 col-md-12">
    ...
    <div class="row draggable-row">
        ...
        <div class="col-md-1">
            <div class="form-group row">
                <div class="col-md-12">
                    <input class="form-control privateValidateControl accounting-item-quantity" type="number" name="items[{{ $accounting_data->pos }}][quantity]" step="0.25" value="{{ $accounting_data->quantity }}" required>
                </div>
            </div>
        </div>
        <div class="col-md-1">
