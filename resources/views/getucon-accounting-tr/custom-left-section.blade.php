<div class="col-lg-4 col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        @else
                                            <select type="text" class="form-control" id="organization" name="organization" required></select>
                                        @endif
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label class="col-md-3 form-label">Editor</label>
                                    <div class="col-md-9">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <select  class="form-control" id="company_id" name="company_id" required @if(!$isCopy)readonly="" style="pointer-events: none" @endif>
    ...
    @endif
                                <div class="form-group row">
                                    <label class="col-md-3 form-label">TAX</label>
                                    <div class="col-md-3">
                                        <select class="form-control" id="kdv" name="kdv" required @if(!$isCopy) readonly="" style="pointer-events: none;" @endif>
                                            <option value="0,00" {{$accounting->kdv==0?"selected":""}}>0</option>
                                            @if($accounting->kdv==18 && !$isCopy)
                                            <option value="18" selected>18</option>
                                            @endif
                                            <option value="20" {{$accounting->kdv==20?"selected":""}}>20</option>
                                        </select>
                                    </div>
                                    <label class="col-md-3 form-label d-flex align-items-center">Total Amount + TAX</label>
                                    <div class="col-md-3">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 form-label">Footnote</label>
                                    <div class="col-md-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 form-label">Delivery Date</label>
                                    <div class="col-md-9">
                                        @if(!$isCopy)
                                ...
                                {{--Eğer Proforma faturası ise deadline tarihi verisini alıyoruz--}}
                                @if( $type == "invoice")
                                    <div class="form-group row">
                                        <label class="col-md-3 form-label">Deadline Date</label>
                                        <div class="col-md-3">
                                            @if(!$isCopy)
